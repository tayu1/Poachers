...
const BOT_PATH = './bots/v5_networth/bot.js';
const WEIGHTS_FILE = './bots/v5_networth/weights.json';
const botModule = require(BOT_PATH);

// Helper to get weights
function getWeights() {
  const defaultP = [
    1.0, 3.0, 3.5, 5.0, 10000.0, 0.5, 0.2, 0.1, 8.0, 0.2, 10.0, 2.0, 0.5
  ];
  try {
...
console.log("Starting v5_networth optimizer...");
