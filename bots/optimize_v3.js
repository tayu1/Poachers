...
const BOT_PATH = './bots/v3_fast/bot.js';
const WEIGHTS_FILE = './bots/v3_fast/weights.json';
...
let generation = 1;
const maxGenerations = 10; // Run 10 generations since it's much faster!

console.log("Starting v3_fast optimizer...");
